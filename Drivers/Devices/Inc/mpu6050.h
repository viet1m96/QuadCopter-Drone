...
#define MPU6050_ACCEL_STILLNESS_THRES0 MPU6050_ACCEL_CONFIG_AFS_SEN0
#define MPU6050_ACCEL_STILLNESS_THRES1 MPU6050_ACCEL_CONFIG_AFS_SEN1
#define MPU6050_ACCEL_STILLNESS_THRES2 MPU6050_ACCEL_CONFIG_AFS_SEN2
#define MPU6050_ACCEL_STILLNESS_THRES3 MPU6050_ACCEL_CONFIG_AFS_SEN3
#define MPU6050_ACCEL_STILLNESS_AXIS_THRES0 (MPU6050_ACCEL_CONFIG_AFS_SEN0 * 0.05f)
#define MPU6050_ACCEL_STILLNESS_AXIS_THRES1 (MPU6050_ACCEL_CONFIG_AFS_SEN1 * 0.05f)
#define MPU6050_ACCEL_STILLNESS_AXIS_THRES2 (MPU6050_ACCEL_CONFIG_AFS_SEN2 * 0.05f)
#define MPU6050_ACCEL_STILLNESS_AXIS_THRES3 (MPU6050_ACCEL_CONFIG_AFS_SEN3 * 0.05f)
#define MPU6050_ACCEL_STILLNESS_ALLOWED_GAP0 (MPU6050_ACCEL_CONFIG_AFS_SEN0 * 0.08f)
#define MPU6050_ACCEL_STILLNESS_ALLOWED_GAP1 (MPU6050_ACCEL_CONFIG_AFS_SEN1 * 0.08f)
#define MPU6050_ACCEL_STILLNESS_ALLOWED_GAP2 (MPU6050_ACCEL_CONFIG_AFS_SEN2 * 0.08f)
#define MPU6050_ACCEL_STILLNESS_ALLOWED_GAP3 (MPU6050_ACCEL_CONFIG_AFS_SEN3 * 0.08f)
